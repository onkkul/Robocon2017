...
if((digitalRead(U1)==0&&digitalRead(U2)==0) && (digitalRead(U3)==0&&digitalRead(U4)==0 &&digitalRead(U5)==1 || digitalRead(U6)==1)&&(digitalRead(U7)==1&&digitalRead(U8)==0))
{
 ...
 if(count==2 || count==6 || count==11 || count==15 || count==18)
 {
  do
  {
   analogWrite(ena,60);
  ...
  else if(count==3 || count==5|| count==8 || count==12||count==17 || count==19 || count==20)
{
     ...
     else if(count==5)
{
    ...
    else if(count==13||count==15)
 {
  ...
  }while( digitalRead(U4)==0 && digitalRead(U5)==0 );
  }
    /*
       else if(count==7)
{
